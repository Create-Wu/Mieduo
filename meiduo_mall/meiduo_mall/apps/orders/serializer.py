...
#
#
# class OrdersSettlemntSerializer(serializers.Serializer):
#     """订单结算数据序列化器"""
#
...
#
#
# class CommitOrdersSerializer(serializers.ModelSerializer):
#     """提交订单序列化器"""
#
#     class Meta:
#         model = OrderInfo
#         fields = ('order_id', 'pay_method', 'address')
#         # orders_id 只做输出，pay_method/address 做输入
...
#                 #
#                 #         # 16 100 *2  1  200*2
#                 #         order.total_amount = order.total_amount + (sku_count * sku.price)
#                 #
...
#                 transaction.savepoint_commit(save_point)  # 如果中间件没有出现异常提交
#
#         # 清除购物车中已结算的商品
